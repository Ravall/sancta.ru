		...
		<div class="outline fix">
			...
			<?php if(pagelines_option('no_credit') || !VDEV): // Thank you for supporting PageLines ?>
				<div id="cred" class="pagelines">
					<a class="plimage" target="_blank" href="<?php if(get_edit_post_link()) echo get_edit_post_link(); else print_pagelines_option('partner_link', 'http://morestyle.ru/');?>" title="<?php echo THEMENAME;?> by PageLines">
