...
<?php 
	//Feature Cycle Setup
	printf( "\$j('#cycle').cycle({fx: '%s', sync: %d, timeout: %d, speed: %d, cleartype: true, cleartypeNoBg: true, pager: 'div#featurenav'});", $feffect, $fsync, $timeout, $speed );
	
	$this->_js_feature_loop($feature_posts);
