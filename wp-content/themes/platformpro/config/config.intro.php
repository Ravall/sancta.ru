...
function get_theme_intro(){
	...
	$intro = '<div class="admin_billboard fix"><div class="admin_theme_screenshot"><img class="" src="'.THEME_ROOT.'/screenshot.png" /></div>' .
		...
		'<li class="feature_support"><div class="feature_icon"></div><strong>Support</strong> <p>For help getting started, we offer our customers tons of support including <a href="http://anonym.to/?http://www.pagelines.com/docs" target="_blank">docs</a>, <a href="http://www.youtube.com/pagelines" target="_blank">video tutorials</a>, and the <a href="http://anonym.to/?http://www.pagelines.com/forum" target="_blank">forum</a>, where users can post questions if they can\'t find the info they need.<br/> You can also visit our <a href="http://anonym.to/?http://www.pagelines.com/support/" target="_blank">support page</a> for more info.</p></li> ' .
