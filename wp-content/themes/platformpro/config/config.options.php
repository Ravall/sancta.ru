	...
	*/	
	$default_options['template_setup'] = array(
				...
				'templates'		=> array(
					...
					'docslink'	=> 'http://anonym.to/?http://www.pagelines.com/docs/template-setup', 
	...
	*/		
	$default_options['layout_editor'] = array(
				...
				'layout_default' => array(
					...
					'docslink'	=> 'http://anonym.to/?http://www.pagelines.com/docs/editing-layout'
				),
				'layout' => array(
					'default'	=> 'one-sidebar-right',
					'type'		=> 'layout',
	...
	*/
	$default_options['typography'] = array(
				...
				'type_inputs' => array(
						...
						'type' 		=> 'typography',
						'selectors'	=> 'input[type="text"], textarea, #dsq-content textarea',
						'inputlabel' 	=> 'Select Font',
	...
	*/		
	...
	$misc_settings['misc_settings'] = array(	
				'partner_link' => array(
						...
						'exp'		=> 'If you are a <a href="http://anonym.to/?http://www.pagelines.com/partners">PageLines Partner</a> enter your link here and the footer link will become a partner or affiliate link.'
				),
				'google_ie' => array(
						'default'	=> false,
						'type'		=> 'check',
	...
	*/
	...
	$custom_code['custom_code'] = array(
				...
				'customcss' => array(
						...
						'docslink'	=> 'http://anonym.to/?http://www.pagelines.com/docs/changing-colors-fonts', 
